              ...
              <div className="max-w-md w-full bg-slate-900 border border-slate-800 p-8 rounded-3xl shadow-2xl text-center">
                  ...
                  {state.players[0]?.userId === myUserId ? (
                      <button
                        ...
                        className="w-full py-4 bg-emerald-600 font-bold rounded-xl text-lg hover:bg-emerald-500 transition-colors disabled:opacity-50 shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)]"
                      >
                        Spiel starten
                      </button>
                  ) : (
          ...
          {state.phase === 'round_end' && (
            <div className="w-full">
              ...
              {state.players[0]?.userId === myUserId ? (
                ...
                <div className="text-slate-400 py-4">Warte auf Host...</div>
              )}
            </div>
          )}
