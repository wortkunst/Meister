          ...
          {state.phase === 'lugloch_decision' && state.pendingCards.length === 1 && (
            <div className="flex flex-col items-center">
              ...
              <div className="flex gap-4 w-full z-10">
                <button onClick={() => dispatch({ type: 'LUGLOCH_PLAY' })} className="flex-1 py-3 bg-gradient-to-b from-emerald-400 to-emerald-600 text-white font-black rounded-xl shadow-[0_4px_0_rgb(4,120,87)] active:shadow-none active:translate-y-[4px] transition-all uppercase tracking-wider">Karte ziehen</button>
